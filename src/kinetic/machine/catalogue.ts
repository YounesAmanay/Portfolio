...
const STRUCTURE: ComponentDef[] = [
  {
    ...
    visual: { shape: 'box', colour: '#2b3442', finish: 'carbon' },
    ports: [],
  },
  {
    id: 'str.rail',
    ...
    visual: { shape: 'box', colour: '#4f8ae0', finish: 'alloy' },
    ports: [],
  },
  {
    id: 'str.pan',
    ...
    visual: { shape: 'box', colour: '#6fa3ea', finish: 'alloy' },
    ports: [],
  },
  {
    id: 'str.plate',
    ...
    visual: { shape: 'box', colour: '#3a7bd5', finish: 'alloy' },
    ports: [],
  },
  {
    id: 'str.tower',
    ...
    visual: { shape: 'box', colour: '#5b93e4', finish: 'alloy' },
    ports: [],
  },
];
...
const ARMOUR: ComponentDef[] = [
  {
    ...
    visual: { shape: 'box', colour: '#eef3f8', finish: 'polymer', opacity: 0.55 },
    ports: [],
  },
  {
    id: 'arm.poly',
  ...
  },
  {
    ...
    visual: { shape: 'box', colour: '#7d8ca3', finish: 'hardened' },
    ports: [],
  },
];
...
const MOTORS: ComponentDef[] = [
  {
    ...
    visual: { shape: 'motor', colour: '#ffb45c', finish: 'alloy' },
  ...
  },
  {
    ...
    visual: { shape: 'motor', colour: '#ff8a1e', finish: 'copper' },
    ports: [port('pwr', 'power', 'in', 'Power'), port('out', 'shaft', 'out', 'Shaft')],
  ...
  },
  {
    ...
    visual: { shape: 'motor', colour: '#f97316', finish: 'steel' },
    ports: [port('pwr', 'power', 'in', 'Power'), port('out', 'shaft', 'out', 'Shaft')],
  ...
  },
  {
    ...
    visual: { shape: 'motor', colour: '#ea6a0c', finish: 'steel' },
    ports: [port('pwr', 'power', 'in', 'Power'), port('out', 'shaft', 'out', 'Shaft')],
  ...
  },
  {
    ...
    visual: { shape: 'motor', colour: '#e85d04', finish: 'copper' },
    ports: [port('pwr', 'power', 'in', 'Power'), port('out', 'shaft', 'out', 'Shaft')],
...
const ENGINES: ComponentDef[] = [
  {
    ...
    visual: { shape: 'engine', colour: '#c2410c', finish: 'alloy' },
  ...
  },
  {
    ...
    visual: { shape: 'engine', colour: '#9a3412', finish: 'alloy' },
    ports: [port('fuel', 'fuel', 'in', 'Fuel'), port('out', 'shaft', 'out', 'Crank')],
...
const TRANSMISSION: ComponentDef[] = [
  {
    ...
    visual: { shape: 'gearbox', colour: '#b6c2d4', finish: 'alloy' },
  ...
  },
  {
    ...
    visual: { shape: 'gearbox', colour: '#a6b3c7', finish: 'alloy' },
    ports: [port('in', 'shaft', 'in', 'Input'), port('out', 'shaft', 'out', 'Output')],
  ...
  },
  {
    ...
    visual: { shape: 'gearbox', colour: '#9aa8bd', finish: 'alloy' },
    ports: [port('in', 'shaft', 'in', 'Input'), port('out', 'shaft', 'out', 'Output')],
  ...
  },
  {
    ...
    visual: { shape: 'gearbox', colour: '#8b9ab0', finish: 'alloy' },
    ports: [port('in', 'shaft', 'in', 'Input'), port('out', 'shaft', 'out', 'Output')],
  ...
  },
  {
    ...
    visual: { shape: 'gearbox', colour: '#7d8da4', finish: 'alloy' },
    ports: [port('in', 'shaft', 'in', 'Input'), port('out', 'shaft', 'out', 'Output')],
  ...
  },
  {
    ...
    visual: { shape: 'gearbox', colour: '#6e7e96', finish: 'steel' },
    ports: [port('in', 'shaft', 'in', 'Input'), port('out', 'shaft', 'out', 'Output')],
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#b6c2d4', finish: 'steel' },
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#9aa8bd', finish: 'steel' },
    ports: [port('in', 'shaft', 'in', 'Crank'), port('out', 'shaft', 'out', 'Output')],
...
const WHEELS: ComponentDef[] = [
  {
    ...
    visual: { shape: 'wheel', colour: '#23272f', finish: 'rubber' },
  ...
  },
  {
    ...
    visual: { shape: 'wheel', colour: '#1c2027', finish: 'rubber' },
    ports: [port('in', 'shaft', 'in', 'Axle')],
  ...
  },
  {
    ...
    visual: { shape: 'wheel', colour: '#191d23', finish: 'rubber' },
    ports: [port('in', 'shaft', 'in', 'Axle')],
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#b6c2d4', finish: 'hardened' },
    ports: [],
...
const POWER: ComponentDef[] = [
  {
    ...
    visual: { shape: 'box', colour: '#5bd68a', finish: 'cell' },
  ...
  },
  {
    ...
    visual: { shape: 'box', colour: '#31c46a', finish: 'cell' },
    ports: [port('out', 'power', 'out', 'Main')],
  ...
  },
  {
    ...
    visual: { shape: 'box', colour: '#22a55a', finish: 'cell' },
    ports: [port('out', 'power', 'out', 'Main')],
  ...
  },
  {
    ...
    visual: { shape: 'box', colour: '#1b8a4b', finish: 'cell' },
    ports: [port('out', 'power', 'out', 'Main')],
  ...
  },
  {
    ...
    visual: { shape: 'box', colour: '#3fb08a', finish: 'cell' },
    ports: [port('out', 'power', 'out', 'Main')],
...
const CONTROL: ComponentDef[] = [
  {
    ...
    visual: { shape: 'board', colour: '#2ad0dc', finish: 'polymer' },
    ports: [
  ...
  },
  {
    ...
    visual: { shape: 'board', colour: '#14b8c4', finish: 'polymer' },
    ports: [
      port('pwr', 'power', 'in', 'Pack'),
      port('sig', 'signal', 'in', 'Signal'),
      port('out', 'power', 'out', 'Motor'),
  ...
  },
  {
    ...
    visual: { shape: 'board', colour: '#0e9aa4', finish: 'polymer' },
    ports: [
      port('pwr', 'power', 'in', 'Pack'),
      port('sig', 'signal', 'in', 'Signal'),
      port('out', 'power', 'out', 'Motor'),
  ...
  },
  {
    ...
    visual: { shape: 'board', colour: '#0a7d85', finish: 'polymer' },
    ports: [
      port('pwr', 'power', 'in', 'Pack'),
      port('sig', 'signal', 'in', 'Signal'),
      port('out', 'power', 'out', 'Motor'),
  ...
  },
  {
    ...
    visual: { shape: 'board', colour: '#17c3b2', finish: 'polymer', emissive: '#37d6a0' },
  ...
  },
  {
    ...
    visual: { shape: 'board', colour: '#0fa79a', finish: 'polymer', emissive: '#37d6a0' },
    ports: [port('out', 'signal', 'out', 'Channels')],
...
const UTILITY: ComponentDef[] = [
  {
    ...
    visual: { shape: 'tank', colour: '#c9d3e0', finish: 'polymer' },
  ...
  },
  {
    ...
    visual: { shape: 'tank', colour: '#b3c1d3', finish: 'polymer' },
    ports: [port('out', 'fuel', 'out', 'Feed')],
    tank: { litres: 1.2 },
  },
  {
...
const WEAPONS: ComponentDef[] = [
  {
    ...
    visual: { shape: 'disc', colour: '#ffc220', finish: 'hardened' },
  ...
  },
  {
    ...
    visual: { shape: 'blade', colour: '#e8452e', finish: 'hardened' },
    ports: [port('in', 'shaft', 'in', 'Drive')],
  ...
  },
  {
    ...
    visual: { shape: 'disc', colour: '#f97316', finish: 'hardened' },
    ports: [port('in', 'shaft', 'in', 'Drive')],
  ...
  },
  {
    ...
    visual: { shape: 'disc', colour: '#e8452e', finish: 'hardened' },
    ports: [port('in', 'shaft', 'in', 'Drive')],
  ...
  },
  {
    ...
    visual: { shape: 'hammer', colour: '#ff6b35', finish: 'hardened' },
  ...
  },
  {
    ...
    visual: { shape: 'flipper', colour: '#e8452e', finish: 'steel' },
    ports: [port('gas', 'gas', 'in', 'Gas')],
...
const PNEUMATICS: ComponentDef[] = [
  {
    ...
    visual: { shape: 'cylinder', colour: '#c9d3e0', finish: 'alloy' },
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#b3c1d3', finish: 'alloy' },
    ports: [port('out', 'gas', 'out', 'Outlet')],
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#8b9ab0', finish: 'steel' },
    ports: [port('out', 'gas', 'out', 'Outlet')],
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#a566e8', finish: 'alloy' },
  ...
  },
  {
    ...
    visual: { shape: 'cylinder', colour: '#8b4fd4', finish: 'alloy' },
    ports: [port('in', 'gas', 'in', 'Inlet'), port('out', 'gas', 'out', 'Outlet')],
    regulator: { bar: 14 },
  },
];
